...
export type AppRole = 'super_admin' | 'hr_admin' | 'payroll_admin' | 'manager' | 'leadership' | 'employee' | 'candidate' | 'alumni'
...
export interface Profile {
  ...
  email: string
  /** F43: stable identity anchor across candidate -> employee -> alumnus */
...
export interface Candidate {
  id: string
  organization_id: string
  /** F43: links this candidate to a login, so they can track their own application */
  profile_id: string | null
  first_name: string
  last_name: string
  email: string
